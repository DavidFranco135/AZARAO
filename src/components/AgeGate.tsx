      ...
      >
        ...
        <div className="p-6 space-y-5">
          <p className="text-slate-300 text-sm leading-relaxed text-center">
            Esta plataforma é destinada exclusivamente a{" "}
            <strong className="text-white">adultos maiores de 18 anos</strong>.
            Ao continuar, você declara ter a idade mínima exigida.
          </p>
          ...
          <div className="p-4 bg-slate-800 rounded-2xl border border-slate-700">
            ...
            >
              ...
              <span className="text-sm text-slate-300 font-medium leading-relaxed select-none">
                Confirmo que tenho{" "}
                <strong className="text-white">18 anos ou mais</strong> e aceito
                os{" "}
                <span
                  onClick={(e) => { e.stopPropagation(); window.open("/termos","_blank"); }}
                ...
                e a{" "}
                <span
                  onClick={(e) => { e.stopPropagation(); window.open("/privacidade","_blank"); }}
                  className="text-indigo-400 hover:underline cursor-pointer"
                >
          ...
          >
            <Shield size={20} /> CONFIRMAR E CADASTRAR
          </button>

          <p className="text-center text-[10px] text-slate-600 font-bold uppercase tracking-widest">
            Menores de 18 anos devem sair desta página
          </p>
        </div>
      </motion.div>
    </div>
